...
Item {
    ...
    property color colorA: LandedTheme.ButtonColorGreen
    property color colorB: LandedTheme.ButtonColorWhite
    ...
    AUIButton {
        ...
        primaryColor: torch.torchOn ? thisTorch.colorA : thisTorch.colorB
