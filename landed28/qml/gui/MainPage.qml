...
//TODO: Call here to getNearestSiteText(nearestArea, currentLocation);
            var distance = formatDistance(getDistance(rs.rows.item(0), currentLocation));
            templateButtons.set(rs.rows.item(0), 'XXXX');
        }
        ...
        function getNearestSiteText(area_id, currentLocation) {
            ...
            return distance + " kms, " + bearingFrom + " of " + nearestSite.name;
        }
